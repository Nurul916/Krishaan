...
<div>
      <button type = "button" name = "sub" class= "btn btn-success font-weight-bold mb-3 mt-3" > <a class="text-white" href="index.php">মুলপাতা</a></button><br>
  ...
  <?php
      ...
      try {
        ...
        $query = "SELECT * FROM farm_specialist WHERE subdistrict LIKE '%$search%' OR district LIKE '%$search%'";
