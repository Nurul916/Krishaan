...
<div class="w3-top">
  <div class="w3-bar w3-green w3-card" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
      ...
      <a href="forum.php" class="w3-bar-item w3-button"><i class="fa fa-user"></i>ফোরাম</a>
      <a href="products.php" class="w3-bar-item w3-button"><i class="fa fa-th"></i> পণ্য সামগ্রী</a>
      
      <a href="news.php" class="w3-bar-item w3-button"><i class="fa fa-newspaper-o"></i>সংবাদ</a>
      <a href="expert.php" class="w3-bar-item w3-button"><i class="fa fa-envelope"></i> বিষেশজ্ঞ</a>
      <a href="books.php" class="w3-bar-item w3-button"><i class="fa fa-book"></i>বই</a>
      <a href="helpline.php" class="w3-bar-item w3-button"><i class="fa fa-phone"></i>হেল্পলাইন</a>
      
      <a href="loginsign.php" class="w3-bar-item w3-button"><i class="fa fa-reply"></i>লগ আউট </a>
    </div>
